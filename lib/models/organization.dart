...
class OrgMember {
  ...
  final bool
      canViewOthersTasks; // may view tasks assigned to other org members (admin always true)
  ...
  OrgMember copyWith({
    ...
    return OrgMember(
      ...
      canViewOthersTasks: canViewOthersTasks ?? this.canViewOthersTasks,
    );
  }
}
